 ...
 */
public class ProductionCompaniesContentProvider extends ContentProvider {

    public static final int PRODUCTION_COMPANIES = 400;

    private static final UriMatcher sUriMatcher = buildUriMatcher();
    private ProductionCompaniesDbHelper mOpenHelper;
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        final String authority = ProductionCompaniesContract.AUTHORITY;

        matcher.addURI(authority, ProductionCompaniesContract.PRODUCTION_COMPANIES, PRODUCTION_COMPANIES);
    ...
    public boolean onCreate() {
        mOpenHelper = new ProductionCompaniesDbHelper(getContext());
        return true;
    }
            ...
            case PRODUCTION_COMPANIES:
                ...
                try {
                    for (ContentValues value : values) {
                        long _id = db.insert(ProductionCompaniesEntry.TABLE_NAME, null, value);
                        if (_id != -1) {
                            rowsInserted++;
                        }
                    }
        ...
        switch (sUriMatcher.match(uri)) {
            case PRODUCTION_COMPANIES:
                cursor = mOpenHelper.getReadableDatabase().query(
                        ProductionCompaniesEntry.TABLE_NAME,
                        projection,
                        selection,
                        selectionArgs,
                        null,
